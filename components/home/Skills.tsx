...
function Skills() {
  return (
    <div className="flex flex-col md:flex-row justify-between relative">
      <h2 className="relative text-2xl sm:text-3xl w-full text-center md:text-left font-bold md:max-w-lg mb-8 md:mr-10 md:mb-0 md:w-max mr-0 ">
        I got the experience.
        <br />
        Here is my toolkit for success.
        <img
